...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2022 at 11:09 PM
...
CREATE TABLE `primary_payment` (
  ...
  `primary_payment_students_reference` varchar(10) NOT NULL,
...
INSERT INTO `primary_school_classes` (`primary_class_id`, `primary_class`) VALUES
(1, 'Basic one'),
(2, 'Basic two'),
(3, 'Basic three'),
(4, 'Basic four'),
...
INSERT INTO `primary_school_students` (`primary_id`, `pri_active_email`, `pri_active`, `pri_paid`, `pri_admit`, `pri_class_id`, `pri_year`, `pri_firstname`, `pri_surname`, `pri_age`, `pri_sex`, `pri_email`, `pri_photo`, `pri_phone`, `pri_address`, `pri_password`, `pri_email_hash`, `pri_cookie_session`, `pri_timestamp`) VALUES
(1, 1, '0', 0, 0, '3', '2022', 'ahmed', 'olusesi', '5', 'Male', 'ola.sesi@yahoo.com', 'ab029b597c08b5f0757b4443fea3e4837d276b9a.png', '08074574512', 'Ikeja', 'password', '', '', '0000-00-00 00:00:00'),
(2, 1, '1', 1, 1, '4', '2022', 'Rasheed', 'Raseed', '4', 'Male', 'oosodof@yahoo.com', '4862698757bed4eada1e9a9ebe2bf84e256773db.JPG', '08074574512', 'Ogba', '', '', '', '2022-01-05 14:36:13'),
(3, 1, '0', 1, 1, '3', '2022', 'duro', 'media', '4', 'Male', 'dfasfds@yahoo.com', '5e8688a0fcf6dd98a52b1acafd7856d8b5fa59f6.JPG', '08074574512', 'Oshodi', '', '', '', '2022-01-05 15:01:22'),
(4, 1, '0', 1, 0, '6', '', 'minus', 'olusesi', '', '', 'Eligendi@enim.com', 'default.jpg', '08074574512', 'Aut ex consequatur ', '', '', '', '2022-01-06 14:47:31'),
(5, 1, '0', 1, 0, '4', '', 'Consequatur', 'Delectus', '', '', 'Corporis@aut.com', 'default.jpg', '08073454632', 'Corrupti dolore seq', '', '', '', '2022-01-06 14:47:31'),
(6, 1, '1', 1, 1, '6', '2022', 'rasheed', 'rasheed', '', '', 'rasheed@test.com', '', '08074574512', 'Ikeja', 'password', '36660e59856b4de58a219bcf4e27eba3', '', '2022-01-14 09:48:57'),
(7, 1, '1', 1, 1, '3', '2022', 'duro', 'duro', '3', 'Female', 'web@duromedia.com.ng', 'b3285c6aeaec1faa574de62167fdef54e268b060.JPG', '08074574512', 'Ikka', '$2y$10$ozqIlrHj3uTkKwud0nwe6u5ioKpkJ.XEvVKsM.NS1.sBAm6Y2EipW', 'd96409bf894217686ba124d7356686c9', '', '2022-02-10 09:33:26'),
(8, 1, '0', 0, 0, '3', '2022', 'Anita', 'Olusesi', '12', 'Female', 'olusesianita@gmail.com', 'cb157db8d214863ab316c844ceffebaa9439878c.JPG', '08074574512', 'ikeja', '$2y$10$mlgOyxryVZ2Oq2LwHz1Y3On6maurSApYe3V7raaKhbhN4PDSG2uvW', 'a8ecbabae151abacba7dbde04f761c37', '', '2022-02-13 23:47:44');
...
INSERT INTO `secondary_school_classes` (`secondary_class_id`, `secondary_class`) VALUES
(1, 'JSS One'),
(2, 'JSS Two'),
(3, 'JSS Three'),
(4, 'SS 1'),
...
--
ALTER TABLE `primary_subjects`
  MODIFY `primary_subjects_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
